...
### Success Messages
$msg_success = "<strong>Thank you</strong> for choosing our apps. We'll email you the download link shortly.";

if( $_SERVER['REQUEST_METHOD'] == 'POST') {
	if (isset($_POST["youremail"]) && $_POST["youremail"] != '' && isset($_POST["yourname"]) && $_POST["yourname"] != '') {
		### Form Fields
		$cf_email = $_POST["youremail"];
		$cf_name = $_POST["yourname"];
		...
		if ($honeypot == '' && !(empty($emailTO))) {
			...
			$bodymsg .= $_SERVER['HTTP_REFERER'] ? '<br>---<br><br>This email was sent from [AppsLand]: ' . $_SERVER['HTTP_REFERER'] : '';
